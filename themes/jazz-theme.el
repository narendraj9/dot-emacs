...
(defmacro with-jazz-theme-palette (&rest body)
  (declare (indent 2))
  `(let ((class '((class color) (min-colors 89)))
         ...
         ;; diff colors (Modus themes)
         (jazz-bg-diff-heading "#304466")
         (jazz-fg-diff-heading "#dae7ff")
         (jazz-bg-diff-added "#0a280a")
         (jazz-fg-diff-added "#94ba94")
         (jazz-bg-diff-removed "#40160f")
         (jazz-fg-diff-removed "#c6adaa")
         (jazz-bg-diff-refine-added "#005a36")
         (jazz-fg-diff-refine-added "#e0f6e0")
         (jazz-bg-diff-refine-changed "#585800")
         (jazz-bg-diff-refine-removed "#852828")
         (jazz-fg-diff-refine-removed "#ffd9eb")
...
(with-jazz-theme-palette
    (custom-theme-set-faces
     ...
     ;; Apropos
     `(apropos-symbol ((,class (:foreground ,jazz-blue :weight bold :underline t))))
     ...
     ;; -- ledger
     `(ledger-font-posting-account-face ((,class (:foreground ,jazz-orange))))

     ;; -- google translate faces
     `(google-translate-text-face ((,class (:foreground ,jazz-blue+1))))
     `(google-translate-translation-face ((,class (:foreground ,jazz-blue+2))))
     `(google-translate-phonetic-face ((,class (:foreground ,jazz-orange-2))))
...
;;; font lock
     ...
     `(font-lock-function-name-face ((,class (:foreground ,jazz-cyan))))
...
;;; external
     ...
     ;; HyRolo
     `(hyrolo-highlight-face ((t (:foreground ,jazz-blue :underline t))))
     ...
     `(org-checkbox ((,class (:background ,jazz-bg+2 :foreground "white"
                                          :box (:line-width 1 :style released-button)))))
     `(org-date ((,class (:foreground ,jazz-orange-1 :underline t))))
     ...
     ;; -- Org agenda (back to original settings)
     ...
     `(eyebrowse-mode-line-active ((,class (:foreground ,jazz-green+4))))
